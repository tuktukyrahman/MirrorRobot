...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://telegra.ph/file/0fec7808e5de5820ca563.jpg" type="image/jpg">
    <script
...
<body>
  <!--© Designed and coded by @itspriyo-Telegram-->
    <header>
      <div class="brand">
        <img
          src="https://telegra.ph/file/0fec7808e5de5820ca563.jpg"
          alt="logo"
        />
        <a href="https://t.me/itspriyo"> 
          <h2 class="name">priyo-mirrorbot</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/tuktukyrahman/priyo-mirrorbot"><i class="fab fa-github"></i></a>
        <a href="https://t.me/itspriyo"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
<body>
   <!--© Designed and coded by @itspriyo-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://github.com/tuktukyrahman/MirrorRobot"><i class="fab fa-github"></i></a>
        <a href="https://t.me/itspriyo"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
